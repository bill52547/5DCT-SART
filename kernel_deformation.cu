__global__ void kernel_deformation(float *img1, float *img, float *my2, float *mx2, float *mz2, int nx, int ny, int nz){
    ...
    float xi = iy + 0.5f + mx2[id];
    float yi = ix + 0.5f + my2[id];
